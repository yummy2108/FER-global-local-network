...
class Conv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, NL='relu', padding=0, dilation=1, bn=False):
...
def tensor_to_variable(x, is_cuda=True, is_training=False):
    if is_training:
        v = Variable(x)
    else:
